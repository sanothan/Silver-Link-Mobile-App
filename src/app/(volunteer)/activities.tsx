...
export default function Activities() {
  ...
  return <SafeAreaView style={styles.safe} edges={['top']}>
    <View style={styles.header}><Text style={styles.title}>My Activities</Text><Text style={styles.subtitle}>Requests you have accepted.</Text><Pressable accessibilityRole="button" onPress={() => router.push('/volunteer-activity-history' as Href)}><Text style={styles.historyLink}>View full activity history →</Text></Pressable></View>
