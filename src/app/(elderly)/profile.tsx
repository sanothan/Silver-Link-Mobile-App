      ...
      >
        ...
        {editing ? (
          ...
          <>
            ...
            <Info label="Locality" value={profile?.locality} />
            <Info
              label="Preferred language"
...
const styles = StyleSheet.create({
  ...
  infoValue: { color: colors.textPrimary, fontSize: 17, fontWeight: "700" },
  ...
  cancelText: { color: colors.textSecondary, fontSize: 16, fontWeight: "800" },
  button: {
    minWidth: 170,
    minHeight: 54,
    marginTop: 14,
