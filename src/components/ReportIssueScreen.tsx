...
export function ReportIssueScreen({ title, message, homeHref }: { title: string; message: string; homeHref: Href }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await submitReport(
        { category, subject: { type: 'none', id: '', label: '' }, description: details },
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.categoryRow}>
          <Pressable
            ...
            style={[styles.categoryOption, category === 'other' && styles.categoryOptionActive]}
            onPress={() => setCategory('other')}
          >
            <Text style={[styles.categoryText, category === 'other' && styles.categoryTextActive]}>General Complaint</Text>
          </Pressable>
          <Pressable
            accessibilityRole="button"
            style={[styles.categoryOption, category === 'unsafe_behaviour' && styles.categoryOptionActiveUrgent]}
            onPress={() => setCategory('unsafe_behaviour')}
          >
            <Text style={[styles.categoryText, category === 'unsafe_behaviour' && styles.categoryTextActive]}>Urgent Safety Concern</Text>
          </Pressable>
        </View>
